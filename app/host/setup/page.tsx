    ...
    const startGame = () => {
        ...
        const questions =
            currentTab === 'predefined'
                ? predefinedQuestions[selectedQuestionSet].questions
                : customQuestions;
                ...
                <Card className="border-0 shadow-xl mb-4">
                                    ...
                                    <TabsContent value="predefined" className="space-y-4">
                                        <div className="space-y-4">
                                            ...
                                            <RadioGroup
                                                ...
                                                onValueChange={value =>
                                                    setSelectedQuestionSet(Number.parseInt(value))
                                                }
                                                className="space-y-2"
                                            >
                    ...
                    <CardFooter className="flex justify-between p-6 pt-0">
                        ...
                        <Button
                            onClick={startGame}
                            disabled={
                                (currentTab === 'custom' && customQuestions.length === 0) ||
                                players.length === 0
                            }
